    ...
    return(
        <section className="p-6 pt-24 pb-24 xl:px-24 bg-sectionBg">
           ...
           <div className="flex flex-col lg:flex-row lg:gap-6 2xl:gap-10 3xl:gap-16 lg:px-10 lg:mt-6 2xl:mt-16 xl:px-0  lg:items-center">
            <div className="lg:w-full xl:w-[90%] 2xl:w-[75%] flex flex-col gap-2">
                <h3 className="font-body text-dark text-[1.25rem] lg:text-[1.18rem] xl:text-[1.25rem] 2xl:text-[1.4rem] 3xl:text-[1.7rem] mt-10">Construye tu futuro ayudando a otros a proteger el suyo.</h3>
                <p className="text-[1.1rem] lg:text-[0.9rem] xl:text-[1.1rem] 3xl:text-[1.3rem] mt-4">En ViBa Financial Services buscamos personas comprometidas, con vision y pasion por transformar vidas a traves de la educacion financiera.</p>
                <span className="font-bold text-[1.1rem] lg:text-[0.9rem] xl:text-[1.1rem] 3xl:text-[1.3rem] text-primary">¿Te identificas? </span>
            </div>
